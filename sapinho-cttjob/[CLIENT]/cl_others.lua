...
Citizen.CreateThread(function()
	local blip = AddBlipForCoord(64.3858, 114.6776, 78.7339, 123.5087)
	...
	AddTextComponentString('Base dos CTT')
...
function getParkingPosition(spots)
  ...
  TriggerEvent('chatMessage', '^1TODOS OS LUGARES ESTAO OCUPADOS')
 end
